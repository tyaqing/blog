  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-grow basis-0 items-center">
        <Link href="/">
          <span className="dark:text-white block w-10 overflow-hidden lg:w-auto">
      ...
      <div className="relative flex basis-0 justify-end space-x-6 sm:space-x-8 md:flex-grow">
        ...
        <Link target={'_blank'} href="https://github.com/tyaqing">
...
export function Layout({ children, title, navigation, tableOfContents }) {
  ...
  // 是否显示目录栏
  const isShowContentTable = router.asPath !== '/'
  ...
  return (
    <>
      ...
      <div className="bg-white dark:bg-slate-900 relative mx-auto flex max-w-8xl justify-center sm:px-2 lg:px-8 xl:px-12">
